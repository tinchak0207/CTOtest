const translations = {
    ...
    zh: {
        ...
        about: {
            title: "關於澳門生產力暨科技轉移中心",
            founding: "澳門生產力暨科技轉移中心（CPTTM）成立於1996年，是由澳門特區政府與私營部門共同設立的非牟利組織。",
            mission: "我們的使命是支持企業有效利用新的概念思維、資訊和資源，以增加其產品或服務的附加價值，旨在促進更高的生產力和更強的競爭力。",
            stats: {
                courses: "每年課程",
                years: "服務年限",
                students: "培訓學員"
